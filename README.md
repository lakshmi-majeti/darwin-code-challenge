...
-  I have created Id field which will be unique and auto generated by the code.
-  For displaying the employee details(for single employee) and delete employee, i assumed input will be id.
